<template>
  <AppLayout>
    <div class="mexion-affiliate-page space-y-6">
      ...
      <template v-else-if="detail">
        <div class="mexion-affiliate-index grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div class="mexion-affiliate-index__item card p-5">
        ...
        <div class="mexion-affiliate-folio card p-6">
          <h3 class="mexion-affiliate-folio__title text-base font-semibold text-gray-900 dark:text-white">{{ t('affiliate.title') }}</h3>
          <p class="mexion-affiliate-folio__lead mt-1 text-sm text-gray-500 dark:text-dark-400">{{ t('affiliate.description') }}</p>

          <div class="mexion-affiliate-credentials mt-5 grid gap-4 md:grid-cols-2">
            <div class="mexion-affiliate-credential space-y-2">
              <p class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('affiliate.yourCode') }}</p>
              <div class="mexion-affiliate-credential__box flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900">
          ...
          <div class="mexion-affiliate-protocol mt-5 rounded-xl border border-primary-200 bg-primary-50 p-4 dark:border-primary-900/40 dark:bg-primary-900/20">
            <p class="text-sm font-medium text-primary-800 dark:text-primary-200">{{ t('affiliate.tips.title') }}</p>
            <ul class="mexion-affiliate-protocol__steps mt-2 space-y-1 text-sm text-primary-700 dark:text-primary-300">
        ...
        <div class="mexion-affiliate-transfer card p-6">
        ...
        <div class="mexion-affiliate-register card p-6">
