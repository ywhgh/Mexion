...
<template>
  <section class="mexion-ops-panel mexion-ops-panel--logs rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-900/60">
