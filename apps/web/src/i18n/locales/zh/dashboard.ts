export default {
  ...
  redeem: {
    ...
    activePlans: '{count} 个活跃套餐',
    redemptionRecords: '兑换记录',
    records: '笔真实记录',
    subscriptionProgress: '订阅进度',
    monthlyProgress: '月度进度',
    dailyProgress: '今日进度',
    nearestExpiry: '最近到期',
    noActiveSubscriptions: '暂无活跃订阅，启用套餐后这里会显示额度进度。',
    accountVoucher: '账户凭单',
    accountVoucherMeta: '实时账户',
    walletBalance: '钱包余额',
    concurrencyQuota: '并发额度',
    codeRules: '兑换规则',
    redeemMetaUnused: '尚未使用',
    redeemMetaProcessing: '正在核销',
    redeemIntro: '输入兑换码即可直接更新账户额度。每个兑换码限用一次，兑换结果即时生效。',
    redeemCodePlaceholderLong: 'xxxxxxxx-xxxxxxxx-xxxxxxxx-xxxxxxxx',
    clearCode: '清空兑换码',
    recentRedemptions: '最近兑换',
    transactions: '交易记录',
    historyCount: '{count} 笔记录',
    date: '日期',
    descriptionLabel: '项目',
    amount: '变动',
    reference: '凭证',
    noHistoryTitle: '暂无兑换记录',
    unlimited: '不限',
    currentBalance: '当前余额',
    concurrency: '并发数',
    requests: '请求',
  ...
  profile: {
    ...
    securityTitle: '安全设置',
    securityDescription: '密码、双因素认证、额度提醒与支持信息依次归档。',
    administrator: '管理员',
    user: '用户',
    username: '用户名',
    email: '邮箱',
