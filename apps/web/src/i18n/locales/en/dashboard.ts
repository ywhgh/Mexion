export default {
  ...
  redeem: {
    ...
    walletBreadcrumb: 'Wallet',
    walletTitle: 'Wallet &',
    walletAccent: 'Top-up',
    realtime: 'Live account',
    ...
    noActiveSubscriptions: 'No active subscription. Quota progress will appear here after a plan is enabled.',
    accountVoucher: 'Account voucher',
    accountVoucherMeta: 'Live account',
    walletBalance: 'Wallet balance',
    concurrencyQuota: 'Concurrency quota',
    codeRules: 'Redemption rules',
    redeemMetaUnused: 'Unused',
    redeemMetaProcessing: 'Validating',
    redeemIntro: 'Enter a redeem code to update the account allowance. Each code can be used once and takes effect immediately.',
    redeemCodePlaceholderLong: 'xxxxxxxx-xxxxxxxx-xxxxxxxx-xxxxxxxx',
    clearCode: 'Clear redeem code',
    ...
    amount: 'Change',
    reference: 'Reference',
    noHistoryTitle: 'No redemption records',
    unlimited: 'Unlimited',
  ...
  profile: {
    ...
    description: 'Identity, security settings, and everyday preferences for this account.',
    memberId: 'Member ID',
    ...
    securityDescription: 'Password, two-factor authentication, balance alerts, and support details are filed in sequence.',
