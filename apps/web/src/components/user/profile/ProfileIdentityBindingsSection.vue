<template>
  <div :class="[props.embedded ? 'space-y-4' : 'card overflow-hidden', 'mexion-profile-bindings']">
    <div
      v-if="!props.embedded"
    ...
    <div :class="props.embedded ? 'space-y-4' : 'divide-y divide-gray-100 dark:divide-dark-700'">
      <div v-if="props.embedded" class="mexion-profile-bindings__intro">
      ...
      <div
        ...
        :key="item.provider"
        :class="[rowClass, 'mexion-profile-binding-entry', props.embedded ? 'profile-binding-row' : '']"
      >
