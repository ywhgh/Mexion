<template>
  <div :class="[props.embedded ? 'space-y-4' : 'card', 'mexion-profile-security-card mexion-profile-password-card']">
    <div
      v-if="!props.embedded"
      class="mexion-profile-security-card__header border-b border-gray-100 px-6 py-4 dark:border-dark-700"
    >
      <h2 class="text-lg font-medium text-gray-900 dark:text-white">
        {{ t('profile.changePassword') }}
      </h2>
    </div>
    <div class="mexion-profile-security-card__body" :class="props.embedded ? '' : 'px-6 py-6'">
      <form @submit.prevent="handleChangePassword" class="mexion-profile-form space-y-4">
        ...
        <div class="mexion-profile-password-actions flex justify-end pt-4">
