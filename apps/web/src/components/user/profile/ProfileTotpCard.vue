<template>
  <div class="card mexion-profile-security-card mexion-profile-totp-card">
    <div class="mexion-profile-security-card__header border-b border-gray-100 px-6 py-4 dark:border-dark-700">
    ...
    <div class="mexion-profile-security-card__body px-6 py-6">
      <!-- Loading state -->
