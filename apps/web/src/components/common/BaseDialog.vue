<template>
  <Teleport to="body">
    <Transition name="modal">
      <div
        v-if="show"
        class="modal-overlay mexion-float-overlay"
        :style="zIndexStyle"
      ...
      >
        <!-- Modal panel -->
        <div ref="dialogRef" :class="['modal-content', 'mexion-float-surface', widthClasses]" @click.stop>
          <!-- Header -->
          <div class="modal-header mexion-float-header">
          ...
          <!-- Body -->
          <div class="modal-body mexion-float-body">
            <slot></slot>
          </div>

          <!-- Footer -->
          <div v-if="$slots.footer" class="modal-footer mexion-float-footer">
