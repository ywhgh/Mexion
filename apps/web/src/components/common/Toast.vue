<template>
  <Teleport to="body">
    <div
      class="mexion-toast-container toast-container pointer-events-none fixed right-4 top-4 z-[9999] space-y-3"
      aria-live="polite"
      aria-atomic="true"
    >
      <TransitionGroup
      ...
      >
        <div
          ...
          :key="toast.id"
          :class="[
            'mexion-toast toast pointer-events-auto min-w-[320px] max-w-md overflow-hidden rounded-lg shadow-lg',
