...
const routes: RouteRecordRaw[] = [
  ...
  // ==================== Legacy Mexion skin redirects ====================
  { path: '/sign-in', redirect: '/login' },
  { path: '/api-keys', redirect: '/keys' },
  { path: '/tokens', redirect: '/keys' },
  { path: '/logs', redirect: '/usage' },
  { path: '/overview', redirect: '/dashboard' },
  { path: '/billing', redirect: '/subscriptions' },
  { path: '/subs', redirect: '/subscriptions' },
  { path: '/models', redirect: '/available-channels' },
  { path: '/status', redirect: '/monitor' },
  { path: '/admin-users', redirect: '/admin/users' },
  { path: '/channels', redirect: '/admin/channels/pricing' },
  { path: '/groups', redirect: '/admin/groups' },
  { path: '/model-aliases', redirect: '/admin/accounts' },
  { path: '/settings', redirect: '/admin/settings' },

  // ==================== Public Routes ====================
  {
    path: '/mexion-preview',
    redirect: '/dashboard?mexion-preview=1',
    meta: {
      requiresAuth: false,
      title: 'Mexion Preview'
    }
  },
  {
    path: '/mexion-preview/',
