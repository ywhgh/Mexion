(function () {
  ...
  var NAV = [
    ...
    { section: 'side.admin', adminOnly: true, items: [
      ...
      { key: 'nav.admin-monitor', en: 'Monitors', zh: '监控管理', href: '/admin/channels/monitor/', adminOnly: true, icon: '<path d="M1.5 8h3l1.3-3.5 2.4 7 1.6-3.5h4.7" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>' },
      { key: 'nav.admin-usage', en: 'Usage', zh: '用量记录', href: '/admin/usage/', adminOnly: true, icon: '<path d="M3 12.5V3.5M3 12.5h10M5.5 10V7M8 10V4.5M10.5 10V6" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/>' },
      { key: 'nav.admin-subscriptions', en: 'Subscriptions', zh: '订阅管理', href: '/admin/subscriptions/', adminOnly: true, icon: '<path d="M8 2.5l5 2.2-5 2.2-5-2.2L8 2.5zM3 7.8l5 2.2 5-2.2M3 10.8l5 2.2 5-2.2" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>' },
      { key: 'nav.admin-redeem', en: 'Redeem Codes', zh: '兑换码', href: '/admin/redeem/', adminOnly: true, icon: '<rect x="2.5" y="4" width="11" height="8" rx="1" stroke="currentColor" stroke-width="1.3"/><path d="M2.5 7h11M8 4v8" stroke="currentColor" stroke-width="1.3"/>' },
      { key: 'nav.admin-promo', en: 'Promo Codes', zh: '优惠码', href: '/admin/promo-codes/', adminOnly: true, icon: '<path d="M3 3h4l6 6-4 4-6-6V3z" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><circle cx="5.5" cy="5.5" r=".7" fill="currentColor"/>' },
      { key: 'nav.admin-proxies', en: 'Proxies', zh: '代理管理', href: '/admin/proxies/', adminOnly: true, icon: '<path d="M3 5h4a2 2 0 0 1 2 2v2a2 2 0 0 0 2 2h2M13 5h-2a2 2 0 0 0-2 2v.5M3 11h2" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/>' },
      { key: 'nav.admin-announcements', en: 'Announcements', zh: '公告管理', href: '/admin/announcements/', adminOnly: true, icon: '<path d="M3 6.5h3l5-2.5v8l-5-2.5H3v-3zM6 9.5l1 3" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/>' },
      { key: 'nav.admin-ops', en: 'Ops', zh: '运维监控', href: '/admin/ops/', adminOnly: true, icon: '<path d="M2.5 10.5l2.8-5 2.3 3.8 2-6 3.9 7.2" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>' },
      { key: 'nav.admin-settings', en: 'Settings', zh: '系统设置', href: '/admin/settings/', adminOnly: true, icon: '<circle cx="8" cy="8" r="2" stroke="currentColor" stroke-width="1.3"/><path d="M8 2.5v1.3M8 12.2v1.3M13.5 8h-1.3M3.8 8H2.5M11.9 4.1l-.9.9M5 11l-.9.9M11.9 11.9l-.9-.9M5 5l-.9-.9" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/>' },
      { key: 'nav.admin-affiliates', en: 'Affiliates', zh: '返利记录', href: '/admin/affiliates/', adminOnly: true, icon: '<path d="M5.5 8a2.5 2.5 0 1 1 2.2-3.7M10.5 8a2.5 2.5 0 1 0-2.2-3.7M2.5 13c.5-2 2-3 4-3h3c2 0 3.5 1 4 3" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/>' },
    ]},
  ];
